...
const BLOCK_START: [u32; 256] = [
    ...
    0x04C00, 0x04E00, 0x04F00, 0x05000, 0x05100, 0x05200, 0x05300, 0x05400,
    0x05500, 0x05600, 0x05700, 0x05800, 0x05900, 0x05A00, 0x05B00, 0x05C00,
    0x05D00, 0x05E00, 0x05F00, 0x06000, 0x06100, 0x06200, 0x06300, 0x06400,
    0x06500, 0x06600, 0x06700, 0x06800, 0x06900, 0x06A00, 0x06B00, 0x06C00,
    0x06D00, 0x06E00, 0x06F00, 0x07000, 0x07100, 0x07200, 0x07300, 0x07400,
    0x07500, 0x07600, 0x07700, 0x07800, 0x07900, 0x07A00, 0x07B00, 0x07C00,
    0x07D00, 0x07E00, 0x07F00, 0x08000, 0x08100, 0x08200, 0x08300, 0x08400,
    0x08500, 0x08600, 0x08700, 0x08800, 0x08900, 0x08A00, 0x08B00, 0x08C00,
    0x08D00, 0x08E00, 0x08F00, 0x09000, 0x09100, 0x09200, 0x09300, 0x09400,
    0x09500, 0x09600, 0x09700, 0x09800, 0x09900, 0x09A00, 0x09B00, 0x09C00,
    0x09D00, 0x09E00, 0x09F00, 0x0A000, 0x0A100, 0x0A200, 0x0A300, 0x0A400,
    0x0A500, 0x0A600, 0x0A700, 0x0A800, 0x0A900, 0x0AA00, 0x0AB00, 0x0AC00,
    0x0AD00, 0x0AE00, 0x0AF00, 0x0B000, 0x0B100, 0x0B200, 0x0B300, 0x0B400,
    0x0B500, 0x0B600, 0x0B700, 0x0B800, 0x0B900, 0x0BA00, 0x0BB00, 0x0BC00,
    0x0BD00, 0x0BE00, 0x0BF00, 0x0C000, 0x0C100, 0x0C200, 0x0C300, 0x0C400,
    0x0C500, 0x0C600, 0x0C700, 0x0C800, 0x0C900, 0x0CA00, 0x0CB00, 0x0CC00,
    0x0CD00, 0x0CE00, 0x0CF00, 0x0D000, 0x0D100, 0x0D200, 0x0D300, 0x0D400,
    0x0D500, 0x0D600, 0x0D700, 0x10000, 0x10100, 0x10200, 0x10300, 0x10400,
    0x10500, 0x10600, 0x10700, 0x10800, 0x10900, 0x10A00, 0x10B00, 0x10C00,
    0x10D00, 0x10E00, 0x10F00, 0x11000, 0x11100, 0x11200, 0x11300, 0x11400,
    0x11500, 0x11600, 0x11700, 0x11800, 0x11900, 0x11A00, 0x11B00, 0x11C00,
    0x11D00, 0x11E00, 0x11F00, 0x12000, 0x12100, 0x12200, 0x12300, 0x12400,
    0x12500, 0x13000, 0x13100, 0x13200, 0x13300, 0x13400, 0x14400, 0x14500,
    0x14600, 0x16800, 0x16900, 0x16A00, 0x16B00, 0x16F00, 0x17000, 0x18700,
    0x18800, 0x18900, 0x18A00, 0x18B00, 0x18C00, 0x18D00, 0x1B000, 0x1B100,
    0x1B200, 0x1B300, 0x1BC00, 0x1D000, 0x1D100, 0x1D200, 0x1D300, 0x1D400,
    0x1D500, 0x1D600, 0x1D700, 0x1E800, 0x1E900, 0x1EC00, 0x1ED00, 0x1EE00,
    0x1F000, 0x1F100, 0x1F200, 0x1F300, 0x1F400, 0x1F500, 0x1F600, 0x1F700,
    0x1F800, 0x1F900, 0x1FA00, 0x1FB00, 0x20000, 0x2A700, 0x2B700, 0x2B800,
];
                ...
                if hi == 255 {
                    if pos != chars.len() - 1 {
                        return Err(MbaseError::invalid_input(
                            "padding character in non-final position",
                        ));
                    }
                    result.push(lo);
                } else {
    ...
    fn detect_score(&self, input: &str) -> DetectCandidate {
        ...
        DetectCandidate {
            ...
            reasons: vec![
                ...
                if all_high_unicode { "all high Unicode".to_string() } else { "mixed".to_string() },
            ],
            warnings: vec![],
        }
    }
...
mod tests {
    ...
    fn test_base65536_lenient_whitespace() {
        ...
        let with_space = format!("{} {}", 
            encoded.chars().take(1).collect::<String>(),
